...
public class Exercise06_15 {
	public static void main(String[] args) {
		...
		for (int i = 50000; i <= 60000; i += 50) {
			System.out.printf("%-15d%5s%-15d%5s%-40d%5s%-18d%5s%-15d\n", i, " ", Math.round(computeTax(1, i)), " ",
					Math.round(computeTax(2, i)), " ", Math.round(computeTax(3, i)), " ", Math.round(computeTax(4, i)));
		}
