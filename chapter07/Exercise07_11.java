...
public class Exercise07_11 {
	public static void main(String[] args) {
		...
		System.out.printf("The standard deviation is %.4f", deviation(array));
	...
	public static double deviation(double[] array) {
		double squareOfDif = 0;
		for (int i = 0; i < array.length; i++) {
			double x = Math.pow(mean(array) - array[i], 2);
			squareOfDif = squareOfDif + x;
		}

		return Math.sqrt(squareOfDif / (array.length - 1));
	}
